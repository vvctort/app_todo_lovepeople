class LoginPageJson {
    ...
    LoginPageJson({this.jwt, this.user});

    LoginPageJson.fromJson(Map<String, dynamic> json) {
        this.jwt = json["jwt"];
...
class User {
    ...
    User.fromJson(Map<String, dynamic> json) {
        ...
        this.todos = json["todos"]==null ? null : (json["todos"] as List).map((e)=>Todos.fromJson(e)).toList();
    }
...
class Todos {
    ...
    Todos({this.id, this.title, this.description, this.completed, this.color, this.user, this.publishedAt, this.createdAt, this.updatedAt});
