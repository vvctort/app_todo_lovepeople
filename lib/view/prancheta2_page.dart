...
class _CadastroState extends State<Cadastro> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CadastroPresenter>(builder: (_, presenter, snapshot) {
        return Form(
          key: _formKey,
          child: Center(
              ...
              child: Column(children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (_formKey.currentState!.validate()) {
                      presenter.obterLogin(_emailController.text,
                          _passworldController.text, _nomeController.text, () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content:
                                    Text('Erro no processo! Tente de novo')));
                      });
                    }
                  },
                  style: ButtonStyle(
